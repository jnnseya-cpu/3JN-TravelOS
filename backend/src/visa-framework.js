...
export const TYPE_DOCUMENTS = {
  ...
  family: ['Marriage certificate', 'Birth certificates', 'Adoption documents', 'Proof of relationship history', 'Photos together', 'Communication history (messages, calls)', 'Joint bills', 'Joint tenancy / mortgage', 'Sponsor immigration status', 'Sponsor passport', 'Sponsor proof of address', 'Sponsor employment letter', 'Sponsor payslips', 'Sponsor bank statements', 'Accommodation suitability proof', 'Consent letters for children', 'Custody documents', 'Divorce decrees from previous marriages'],
  medical: ['Medical diagnosis', 'Referral letter', 'Hospital invitation', 'Treatment plan', 'Cost estimate', 'Proof of payment / deposit', 'Doctor letter', 'Medical insurance', 'Proof of funds', 'Companion details', 'Return plan after treatment'],
  transit: ['Valid passport (6+ months)', 'Passport copy', 'Completed transit application form', 'Colour photograph', 'Destination-country visa', 'Confirmed onward ticket', 'Airline booking reference', 'Transit airport details', 'Layover duration', 'Proof of final-destination entry permission', 'Hotel booking (overnight transit)'],
};
