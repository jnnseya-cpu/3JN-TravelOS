...
export const KNOWLEDGE = {
  ...
  priceGuard: 'Your booked price is locked — it is fixed in your booking terms and protected from fare increases and currency movement until you travel. You pay monthly at the price you locked on day one (a small, transparent pay-monthly fee applies, shown up front).',
