...
const INTENTS = [
  ...
  { key: 'change', escalate: false, re: /\b(change|amend|reschedul|move (my )?(flight|booking|date|hotel|trip)|different date|bring forward|push back|add\b.*\b(passenger|traveller|traveler|person|bag|baggage|suitcase|night|breakfast|board|meal)|extra (bag|baggage|luggage|suitcase|night)|checked bag|extend (my )?(stay|trip)|upgrade\b.*\b(room|board|breakfast|meal|hotel)|room upgrade|breakfast|half board|full board|board basis|bed (and|&) breakfast|all[- ]inclusive)/i },
